...
const Profile = () => {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-center mt-20">Welcome Profile</h2>
      <div className="felx justify-center w-11/12 mx-auto border-2 my-5">
        <div className=" p-8 sm:flex sm:space-x-6 dark:bg-gray-50 dark:text-gray-800">
          <div className="flex-shrink-0  mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0 ">
            <img
              src={user.photoURL}
              alt=""
              className="object-cover object-center  h-full rounded dark:bg-gray-500"
            />
          </div>
